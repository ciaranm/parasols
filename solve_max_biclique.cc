...
namespace
{
    ...
    auto run_this(Func_ func) -> std::function<MaxBicliqueResult (const std::string &, MaxBicliqueParams &, bool &, int)>
    {
        return [func] (const std::string & filename, MaxBicliqueParams & params, bool & aborted, int timeout) -> MaxBicliqueResult {
